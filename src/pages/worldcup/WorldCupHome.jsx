...
export default function WorldCupHome() {
  ...
  return (
    <div className="min-h-screen bg-pitch">
      ...
      <SectionReveal>
        <section id="products" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-[#FDFBF7]">
          <div className="max-w-[1400px] mx-auto">

            {/* Header Area */}
            <div className="max-w-xl mb-12 sm:mb-14 md:mb-16 text-left">
              <span className="text-[9px] sm:text-[10px] font-bold tracking-[0.2em] text-[#C1623F] uppercase mb-3 sm:mb-4 block">
                THE DIGITAL COLLECTION
              </span>
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-charcoal leading-tight mb-4 sm:mb-5">
                Four Tiers. <br />
                <span className="italic text-[#C1623F]">One Heritage.</span>
              </h2>
              <p className="text-charcoal-soft text-[13px] sm:text-[13.5px] leading-relaxed">
            ...
            <div className="mt-12 sm:mt-14 md:mt-16">
              <div className="bg-[#F5EFE6] border border-[#C5A665]/10 rounded-2xl p-5 sm:p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-5 sm:gap-6 text-left">
                <div>
                  <h4 className="font-serif text-base sm:text-lg md:text-xl text-charcoal font-semibold mb-2">
                    Building a premium venue experience?
                  </h4>
                  <p className="text-xs sm:text-[13px] text-charcoal-soft leading-relaxed">
                ...
                <a
                  ...
                  className="w-full md:w-auto whitespace-nowrap px-6 sm:px-8 py-3 sm:py-3.5 bg-[#111111] text-white hover:bg-black rounded-xl font-bold uppercase tracking-wider text-[10px] sm:text-[11px] transition-all shadow-md hover:shadow-lg min-h-[48px] md:min-h-0 flex items-center justify-center"
                >
